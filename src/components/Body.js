...
const Body = () => {
    const[listOfResturant, setResturantList] = useState( [
        {
          type: "restaurant",
          data: {
            type: "F",
        ...
        <div className='body'>
            ...
            <div className="filter">
                <button className='filter-btn' onClick={() => {
                  const restData=  listOfResturant.filter((res) => res.data.avgRating > 4)
                    
                    setResturantList(restData);
            ...
            {
                listOfResturant.map((resturants) => <ResturantCard key={resturants.data.id} resData={ resturants} />)
            }
