    ...
    return (
        <div className='header'>
            <div className='logo-container'>
                <img  className="logo" src="https://img.freepik.com/premium-vector/restaurant-logo-design-template_79169-56.jpg?w=360"/>
            </div>
...
const   Body=() => {
    return (
        <div className='body'>
            ...
            {
                restaurantList.map((resturants) => <ResturantCard key={resturants.data.id} resData={ resturants} />)
            }
